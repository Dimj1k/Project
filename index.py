...
from src.third.methodsVisualization import AndrewsCurve, parallel_coordinates
...
def main() -> None:
    ...
    try:
        ...
        return main()
    print("Файл найден")
    method = int(input("Выберите метод (число 1 или любое целое): "))
